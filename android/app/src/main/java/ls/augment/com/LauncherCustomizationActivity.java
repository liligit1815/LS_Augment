...
public final class LauncherCustomizationActivity extends Activity {
    private LauncherEditorController editor;
    @Override protected void onCreate(Bundle state){super.onCreate(state);editor=new LauncherEditorController(this,"launcher_custom",false);editor.onCreate(state);}

...
| 消失吧APP | 按空间选择应用、批量隐藏／显示、息屏自动隐藏、自定义磁贴 |
...
“消失吧APP”：在“关于”连续点击“系统版本”七次，再回主页查看；离开应用前台后入口重新锁定。详见[功能说明](docs/最新版功能说明.md)。
...
当前目录不含“红魔助手”参考工程、修改版桌面独立工程、原厂 APK、历史诊断输出或私有签名备份。修改版桌面不是本仓库构建目标；模块仍保留桌面增强与兼容性检测。
